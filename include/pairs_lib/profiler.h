...
#include <pairs_msgs/msg/profiler_update.hpp>
...
namespace pairs_lib
{
  ...
  private:
    ...
    std::shared_ptr<pairs_lib::PublisherHandler<pairs_msgs::msg::ProfilerUpdate>> publisher_;
    ...
    pairs_msgs::msg::ProfilerUpdate msg_out_;
  };
