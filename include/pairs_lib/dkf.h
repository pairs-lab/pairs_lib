...
namespace pairs_lib
{
  ...
  */
  ...
  public:
    ...
    using pt3_t = pairs_lib::geometry::vec3_t;
    using pt2_t = pairs_lib::geometry::vec2_t;
    using vec3_t = pairs_lib::geometry::vec3_t;
    //}
  ...
  /*!
    ...
    */
    virtual std::enable_if_t<((n > 3) || (n == Eigen::Dynamic)), statecov_t> correctLine(const statecov_t& sc, const pt3_t& line_origin, const vec3_t& line_direction, const double line_variance) const
    {
      ...
      const mat3_t rot = pairs_lib::geometry::rotationBetween(W_t::UnitX(), W);
