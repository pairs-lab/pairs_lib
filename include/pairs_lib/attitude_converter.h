...
public:
  ...
  /**
   * @brief pairs_lib::EulerAttitude constructor
   *
   * @param euler_attitude pairs_lib::EulerAttitude
   */
  AttitudeConverter(const pairs_lib::EulerAttitude& euler_attitude);
...
template <>
struct std::tuple_size<pairs_lib::AttitudeConverter>
{ static constexpr int value = 3; };

template <>
struct std::tuple_element<0, pairs_lib::AttitudeConverter>
{ using type = double; };

template <>
struct std::tuple_element<1, pairs_lib::AttitudeConverter>
{ using type = double; };

template <>
struct std::tuple_element<2, pairs_lib::AttitudeConverter>
{ using type = double; };
