#ifndef PAIRS_LIB_INTERNAL_COROUTINE_CALLBACK_HELPERS_HPP_
#define PAIRS_LIB_INTERNAL_COROUTINE_CALLBACK_HELPERS_HPP_


#include <rclcpp/callback_group.hpp>


namespace pairs_lib::internal
{
  ...
  inline void require_callback_group_coro_compatible(const std::shared_ptr<rclcpp::CallbackGroup>& callback_group)
  {
    if (callback_group == nullptr || callback_group->type() != rclcpp::CallbackGroupType::Reentrant)
    {
      ...
      RCLCPP_ERROR(rclcpp::get_logger("pairs_lib"), "%s", msg.c_str());
...
#endif // PAIRS_LIB_INTERNAL_COROUTINE_CALLBACK_HELPERS_HPP_
