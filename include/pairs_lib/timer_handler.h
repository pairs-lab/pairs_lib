...
namespace pairs_lib
{
      ...
      return [is_running, method, instance]() -> void {
        ...
        if (!was_running)
        {
          ...
          internal::start_task(
              ...
              [](std::shared_ptr<std::atomic<bool>> is_running, Task<> (C::*method)(), C* instance) -> pairs_lib::Task<> {
  ...
  public:
    ...
    ROSTimer(const pairs_lib::TimerHandlerOptions& opts, const rclcpp::Rate& rate, const std::function<void()>& callback);
     ...
     */
    template <typename C>
    ROSTimer(const pairs_lib::TimerHandlerOptions& opts, const rclcpp::Rate& rate, Task<> (C::*method)(), C* instance)
     ...
     */
    template <typename C>
    ROSTimer(const pairs_lib::TimerHandlerOptions& opts, const rclcpp::Rate& rate, Task<> (C::*method)(), std::shared_ptr<C> instance)
        : ROSTimer(opts, rate, createNonReentrantCallback(method, instance))
    {
      internal::require_callback_group_coro_compatible(opts.callback_group.value_or(nullptr));
    }
  ...
  public:
    ...
    ThreadTimer(const pairs_lib::TimerHandlerOptions& opts, const rclcpp::Rate& rate, const std::function<void()>& callback);
     ...
     */
    template <typename C>
    ThreadTimer(const pairs_lib::TimerHandlerOptions& opts, const rclcpp::Rate& rate, Task<> (C::*method)(), C* instance)
     ...
     */
    template <typename C>
    ThreadTimer(const pairs_lib::TimerHandlerOptions& opts, const rclcpp::Rate& rate, Task<> (C::*method)(), std::shared_ptr<C> instance)
        : ThreadTimer(opts, rate, createNonReentrantCallback(method, instance))
    {
      internal::require_callback_group_coro_compatible(opts.callback_group.value_or(nullptr));
    }
