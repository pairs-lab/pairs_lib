...
namespace pairs_lib
{
  ...
  {
    using errorgraph_error_msg_t = pairs_msgs::msg::ErrorgraphError;
    using errorgraph_element_msg_t = pairs_msgs::msg::ErrorgraphElement;
     ...
     * \see ErroGraphViewer at https://github.com/pairs-lab/pairs_errorgraph_viewer
