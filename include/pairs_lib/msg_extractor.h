...
namespace pairs_lib
{
  ...
  /* pairs_msgs::msg::TrackerCommand //{ */

  /* getPosition() //{ */

  /**
   * @brief get position data from pairs_msgs::msg::TrackerCommand
   *
   * @param data position command
   *
   * @return x, y, z
   */
  std::tuple<double, double, double> getPosition(const pairs_msgs::msg::TrackerCommand& data);

  /**
   * @brief get position data from pairs_msgs::msg::TrackerCommandSharedPtr
   *
   * @param data position command (SharedPtr)
   *
   * @return x, y, z
   */
  std::tuple<double, double, double> getPosition(const pairs_msgs::msg::TrackerCommand::SharedPtr& data);

  /**
   * @brief get position data from pairs_msgs::msg::TrackerCommand::SharedPtr
   *
   * @param data position command (ConstSharedPtr)
   *
   * @return x, y, z
   */
  std::tuple<double, double, double> getPosition(const pairs_msgs::msg::TrackerCommand::ConstSharedPtr& data);
  ...
  /**
   * @brief get velocity data from pairs_msgs::msg::TrackerCommand
   *
   * @param data position command
   *
   * @return x, y, z
   */
  std::tuple<double, double, double> getVelocity(const pairs_msgs::msg::TrackerCommand& data);

  /**
   * @brief get velocity data from pairs_msgs::msg::TrackerCommand::SharedPtr
   *
   * @param data position command (SharedPtr)
   *
   * @return x, y, z
   */
  std::tuple<double, double, double> getVelocity(const pairs_msgs::msg::TrackerCommand::SharedPtr& data);

  /**
   * @brief get velocity data from pairs_msgs::msg::TrackerCommand::ConstSharedPtr
   *
   * @param data position command (ConstSharedPtr)
   *
   * @return x, y, z
   */
  std::tuple<double, double, double> getVelocity(const pairs_msgs::msg::TrackerCommand::ConstSharedPtr& data);
  ...
  /**
   * @brief get heading from pairs_msgs::msg::TrackerCommand
   *
   * @param data position command
   *
   * @return heading
   */
  double getHeading(const pairs_msgs::msg::TrackerCommand& data);

  /**
   * @brief get heading from pairs_msgs::msg::TrackerCommand::SharedPtr
   *
   * @param data position command (SharedPtr)
   *
   * @return heading
   */
  double getHeading(const pairs_msgs::msg::TrackerCommand::SharedPtr& data);

  /**
   * @brief get heading from pairs_msgs::msg::TrackerCommand::ConstSharedPtr
   *
   * @param data position command (ConstSharedPtr)
   *
   * @return heading
   */
  double getHeading(const pairs_msgs::msg::TrackerCommand::ConstSharedPtr& data);

  //}

  //}

  /* pairs_msgs::msg::Reference //{ */

  /* getPosition() //{ */

  /**
   * @brief get position from pairs_msgs::msg::Reference
   *
   * @param data reference
   *
   * @return x, y, z
   */
  std::tuple<double, double, double> getPosition(const pairs_msgs::msg::Reference& data);

  /**
   * @brief get position from pairs_msgs::msg::Reference::SharedPtr
   *
   * @param data reference (SharedPtr)
   *
   * @return x, y, z
   */
  std::tuple<double, double, double> getPosition(const pairs_msgs::msg::Reference::SharedPtr& data);

  /**
   * @brief get position from pairs_msgs::msg::Reference::ConstSharedPtr
   *
   * @param data reference (ConstSharedPtr)
   *
   * @return x, y, z
   */
  std::tuple<double, double, double> getPosition(const pairs_msgs::msg::Reference::ConstSharedPtr& data);
  ...
  /**
   * @brief get heading from pairs_msgs::msg::Reference
   *
   * @param data reference
   *
   * @return heading
   */
  double getHeading(const pairs_msgs::msg::Reference& data);

  /**
   * @brief get heading from pairs_msgs::msg::ReferenceSharedPtr
   *
   * @param data reference (SharedPtr)
   *
   * @return heading
   */
  double getHeading(const pairs_msgs::msg::Reference::SharedPtr& data);

  /**
   * @brief get heading from pairs_msgs::msg::ReferenceConstSharedPtr
   *
   * @param data reference (ConstSharedPtr)
   *
   * @return heading
   */
  double getHeading(const pairs_msgs::msg::Reference::ConstSharedPtr& data);

  //}

  //}

  /* pairs_msgs::msg::ReferenceStamped //{ */

  /* getPosition() //{ */

  /**
   * @brief get position from pairs_msgs::msg::ReferenceStamped
   *
   * @param data reference stamped
   *
   * @return x, y, z
   */
  std::tuple<double, double, double> getPosition(const pairs_msgs::msg::ReferenceStamped& data);

  /**
   * @brief get position from pairs_msgs::msg::ReferenceStamped::SharedPtr
   *
   * @param data reference stamped (SharedPtr)
   *
   * @return x, y, z
   */
  std::tuple<double, double, double> getPosition(const pairs_msgs::msg::ReferenceStamped::SharedPtr& data);

  /**
   * @brief get position from pairs_msgs::msg::ReferenceStamped::ConstSharedPtr
   *
   * @param data reference stamped (ConstSharedPtr)
   *
   * @return x, y, z
   */
  std::tuple<double, double, double> getPosition(const pairs_msgs::msg::ReferenceStamped::ConstSharedPtr& data);
  ...
  /**
   * @brief get heading from pairs_msgs::msg::ReferenceStamped
   *
   * @param data referencestamped
   *
   * @return heading
   */
  double getHeading(const pairs_msgs::msg::ReferenceStamped& data);

  /**
   * @brief get heading from pairs_msgs::msg::ReferenceStamped::SharedPtr
   *
   * @param data referencestamped (SharedPtr)
   *
   * @return heading
   */
  double getHeading(const pairs_msgs::msg::ReferenceStamped::SharedPtr& data);

  /**
   * @brief get heading from pairs_msgs::msg::ReferenceStamped::ConstSharedPtr
   *
   * @param data referencestamped (ConstSharedPtr)
   *
   * @return heading
   */
  double getHeading(const pairs_msgs::msg::ReferenceStamped::ConstSharedPtr& data);
