...
double getHeading(const geometry_msgs::Pose& data) {
  ...
  return pairs_lib::AttitudeConverter(data.orientation).getHeading();
}
...
double getYaw(const geometry_msgs::Pose& data) {
  ...
  return pairs_lib::AttitudeConverter(data.orientation).getYaw();
}
...
/* pairs_msgs::TrackerCommand //{ */

/* getPosition() //{ */

/**
 * @brief get position data from pairs_msgs::TrackerCommand
 *
 * @param data position command
 *
 * @return x, y, z
 */
std::tuple<double, double, double> getPosition(const pairs_msgs::TrackerCommand& data) {

  return getXYZ(data.position);
}

/**
 * @brief get position data from pairs_msgs::TrackerCommandConstPtr
 *
 * @param data position command (ConstPtr)
 *
 * @return x, y, z
 */
std::tuple<double, double, double> getPosition(const pairs_msgs::TrackerCommandConstPtr& data) {
...
/**
 * @brief get velocity data from pairs_msgs::TrackerCommand
 *
 * @param data position command
 *
 * @return x, y, z
 */
std::tuple<double, double, double> getVelocity(const pairs_msgs::TrackerCommand& data) {

  return getXYZ(data.velocity);
}

/**
 * @brief get velocity data from pairs_msgs::TrackerCommandConstPtr
 *
 * @param data position command (ConstPtr)
 *
 * @return x, y, z
 */
std::tuple<double, double, double> getVelocity(const pairs_msgs::TrackerCommandConstPtr& data) {
...
/**
 * @brief get heading from pairs_msgs::TrackerCommand
 *
 * @param data position command
 *
 * @return heading
 */
double getHeading(const pairs_msgs::TrackerCommand& data) {
  ...
  if (data.use_heading) {
    ...
    heading = pairs_lib::AttitudeConverter(data.orientation).getHeading();
  }
...
/**
 * @brief get heading from pairs_msgs::TrackerCommandConstPtr
 *
 * @param data position command (ConstPtr)
 *
 * @return heading
 */
double getHeading(const pairs_msgs::TrackerCommandConstPtr& data) {
...
/* pairs_msgs::Reference //{ */

/* getPosition() //{ */

/**
 * @brief get position from pairs_msgs::Reference
 *
 * @param data reference
 *
 * @return x, y, z
 */
std::tuple<double, double, double> getPosition(const pairs_msgs::Reference& data) {

  return getXYZ(data.position);
}

/**
 * @brief get position from pairs_msgs::ReferenceConstPtr
 *
 * @param data reference (ContrPtr)
 *
 * @return x, y, z
 */
std::tuple<double, double, double> getPosition(const pairs_msgs::ReferenceConstPtr& data) {
...
/**
 * @brief get heading from pairs_msgs::Reference
 *
 * @param data reference
 *
 * @return heading
 */
double getHeading(const pairs_msgs::Reference& data) {

  return data.heading;
}

/**
 * @brief get heading from pairs_msgs::ReferenceConstPtr
 *
 * @param data reference (ContrPtr)
 *
 * @return heading
 */
double getHeading(const pairs_msgs::ReferenceConstPtr& data) {
...
/* pairs_msgs::ReferenceStamped //{ */

/* getPosition() //{ */

/**
 * @brief get position from pairs_msgs::ReferenceStamped
 *
 * @param data reference stamped
 *
 * @return x, y, z
 */
std::tuple<double, double, double> getPosition(const pairs_msgs::ReferenceStamped& data) {

  return getPosition(data.reference);
}

/**
 * @brief get position from pairs_msgs::ReferenceStampedConstPtr
 *
 * @param data reference stamped (ContrPtr)
 *
 * @return x, y, z
 */
std::tuple<double, double, double> getPosition(const pairs_msgs::ReferenceStampedConstPtr& data) {
...
/**
 * @brief get heading from pairs_msgs::ReferenceStamped
 *
 * @param data referencestamped
 *
 * @return heading
 */
double getHeading(const pairs_msgs::ReferenceStamped& data) {

  return getHeading(data.reference);
}

/**
 * @brief get heading from pairs_msgs::ReferenceStampedConstPtr
 *
 * @param data referencestamped (ContrPtr)
 *
 * @return heading
 */
double getHeading(const pairs_msgs::ReferenceStampedConstPtr& data) {
