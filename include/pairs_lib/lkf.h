...
namespace pairs_lib
{
  ...
  */
  ...
  /* class LKF_PAIRS_odom //{ */
  class LKF_PAIRS_odom : public LKF<3, 1, 1>
  {
  public:
    /* LKF definitions (typedefs, constants etc) //{ */
  ...
  public:
    LKF_PAIRS_odom(const std::vector<H_t>& Hs, const double default_dt = 1);
    virtual statecov_t predict(const statecov_t& sc, const u_t& u, const Q_t& Q, double dt) const override;
