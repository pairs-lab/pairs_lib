...
namespace pairs_lib
{
  ...
  private:
    ...
    // Static markers
    pairs_lib::PublisherHandler<visualization_msgs::msg::MarkerArray> publisher_;
    pairs_lib::PublisherHandler<visualization_msgs::msg::MarkerArray> coordinate_publisher_;
