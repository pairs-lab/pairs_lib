...
namespace pairs_lib
{
  ...
  public:
     ...
     * @param timeout time in seconds after which the object should be removed from buffer
     */
    void addRay(const pairs_lib::geometry::Ray& ray, const double r = 1.0, const double g = 0.0, const double b = 0.0, const double a = 1.0,
                const rclcpp::Duration& timeout = rclcpp::Duration(std::chrono::seconds(0)));
     ...
     * @param timeout time in seconds after which the object should be removed from buffer
     */
    void addTriangle(const pairs_lib::geometry::Triangle& tri, const double r = 0.5, const double g = 0.5, const double b = 0.0, const double a = 1.0,
     ...
     * @param timeout time in seconds after which the object should be removed from buffer
     */
    void addRectangle(const pairs_lib::geometry::Rectangle& rect, const double r = 0.5, const double g = 0.5, const double b = 0.0, const double a = 1.0,
                      const bool filled = true, const rclcpp::Duration& timeout = rclcpp::Duration(std::chrono::seconds(0)));
     ...
     * @param timeout time in seconds after which the object should be removed from buffer
     */
    void addCuboid(const pairs_lib::geometry::Cuboid& cuboid, const double r = 0.5, const double g = 0.5, const double b = 0.0, const double a = 1.0,
                   const bool filled = true, const rclcpp::Duration& timeout = rclcpp::Duration(std::chrono::seconds(0)));
     ...
     * @param timeout time in seconds after which the object should be removed from buffer
     */
    void addEllipse(const pairs_lib::geometry::Ellipse& ellipse, const double r = 0.0, const double g = 1.0, const double b = 1.0, const double a = 1.0,
     ...
     * @param timeout time in seconds after which the object should be removed from buffer
     */
    void addCylinder(const pairs_lib::geometry::Cylinder& cylinder, const double r = 0.7, const double g = 0.8, const double b = 0.3, const double a = 1.0,
     ...
     * @param timeout time in seconds after which the object should be removed from buffer
     */
    void addCone(const pairs_lib::geometry::Cone& cone, const double r = 0.7, const double g = 0.8, const double b = 0.3, const double a = 1.0,
                 const bool filled = true, const bool capped = true, const int sides = DEFAULT_ELLIPSE_POINTS,
                 const rclcpp::Duration& timeout = rclcpp::Duration(std::chrono::seconds(0)));
     ...
     * @param timeout time in seconds after which the object should be removed from buffer
     */
    void addPath(const pairs_msgs::msg::Path& p, const double r = 0.3, const double g = 1.0, const double b = 0.3, const double a = 1.0, const bool filled = true,
                 const rclcpp::Duration& timeout = rclcpp::Duration(std::chrono::seconds(0)));
     ...
     * @param timeout time in seconds after which the object should be removed from buffer
     */
    void addTrajectory(const pairs_msgs::msg::TrajectoryReference& traj, const double r = 0.3, const double g = 1.0, const double b = 0.3, const double a = 1.0,
                       const bool filled = true, const rclcpp::Duration& timeout = rclcpp::Duration(std::chrono::seconds(0)));
