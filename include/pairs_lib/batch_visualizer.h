...
public:
   ...
   * @param timeout time in seconds after which the object should be removed from buffer
   */
  void addPath(const pairs_msgs::Path &p, const double r = 0.3, const double g = 1.0, const double b = 0.3, const double a = 1.0, const bool filled = true,
               const ros::Duration &timeout = ros::Duration(0));
   ...
   * @param timeout time in seconds after which the object should be removed from buffer
   */
  void addTrajectory(const pairs_msgs::TrajectoryReference &traj, const double r = 0.3, const double g = 1.0, const double b = 0.3, const double a = 1.0,
                     const bool filled = true, const ros::Duration &timeout = ros::Duration(0));
