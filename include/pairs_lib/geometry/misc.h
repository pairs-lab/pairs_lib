...
namespace pairs_lib
{
  namespace geometry
  {
     ...
     * \tparam OutRangeT the subclass of pairs_lib::cyclic used to wrap the result.
     *
     * \returns the heading angle in the ENU frame (in radians).
     *
     * \note By default, the function also wraps the angle to be in the interval [-pi; pi]. To change this, pass a different OutRangeT template parameter from the pairs_lib::cyclic library.
     */
     ...
     *
     * \note By default, the function also wraps the angle to be in the interval [0; 2pi]. To change this, pass a different OutRangeT template parameter from the pairs_lib::cyclic library.
     */
