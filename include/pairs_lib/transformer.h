...
namespace pairs_lib
{
  ...
  private:
    ...
    std::optional<pairs_msgs::Reference> transformImpl(const geometry_msgs::TransformStamped& tf, const pairs_msgs::Reference& what);
    std::optional<pairs_msgs::ReferenceStamped> transformImpl(const geometry_msgs::TransformStamped& tf, const pairs_msgs::ReferenceStamped& what);
