...
/* addRay */  //{
void BatchVisualizer::addRay(const pairs_lib::geometry::Ray &ray, const double r, const double g, const double b, const double a, const ros::Duration &timeout) {
...
/* addTriangle //{ */
void BatchVisualizer::addTriangle(const pairs_lib::geometry::Triangle &tri, const double r, const double g, const double b, const double a, const bool filled,
...
/* addRectangle //{ */
void BatchVisualizer::addRectangle(const pairs_lib::geometry::Rectangle &rect, const double r, const double g, const double b, const double a, const bool filled,
                                   const ros::Duration &timeout) {
...
/* addCuboid //{ */
void BatchVisualizer::addCuboid(const pairs_lib::geometry::Cuboid &cuboid, const double r, const double g, const double b, const double a, const bool filled,
                                const ros::Duration &timeout) {
...
/* addEllipse //{ */
void BatchVisualizer::addEllipse(const pairs_lib::geometry::Ellipse &ellipse, const double r, const double g, const double b, const double a, const bool filled,
...
/* addCylinder //{ */
void BatchVisualizer::addCylinder(const pairs_lib::geometry::Cylinder &cylinder, const double r, const double g, const double b, const double a,
...
/* addCone //{ */
void BatchVisualizer::addCone(const pairs_lib::geometry::Cone &cone, const double r, const double g, const double b, const double a, const bool filled,
...
/* addPath //{ */
void BatchVisualizer::addPath(const pairs_msgs::Path &p, const double r, const double g, const double b, const double a, const bool filled,
                              const ros::Duration &timeout) {
...
/* addTrajectory //{ */
void BatchVisualizer::addTrajectory(const pairs_msgs::TrajectoryReference &traj, const double r, const double g, const double b, const double a,
