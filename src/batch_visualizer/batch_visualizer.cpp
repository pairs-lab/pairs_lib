...
namespace pairs_lib
{
  ...
  /* addRay */ //{
  void BatchVisualizer::addRay(const pairs_lib::geometry::Ray& ray, const double r, const double g, const double b, const double a,
  ...
  /* addRectangle //{ */
  void BatchVisualizer::addRectangle(const pairs_lib::geometry::Rectangle& rect, const double r, const double g, const double b, const double a,
  ...
  /* addPath //{ */
  void BatchVisualizer::addPath(const pairs_msgs::msg::Path& p, const double r, const double g, const double b, const double a, const bool filled,
                                const rclcpp::Duration& timeout)
  {
  ...
  /* addTrajectory //{ */
  void BatchVisualizer::addTrajectory(const pairs_msgs::msg::TrajectoryReference& traj, const double r, const double g, const double b, const double a,
                                      const bool filled, const rclcpp::Duration& timeout)
  {
