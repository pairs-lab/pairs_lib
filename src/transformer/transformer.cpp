...
using test_t = pairs_msgs::msg::ReferenceStamped;
/* using test_t = pcl::PointCloud<pcl::PointXYZ>; */
template std::optional<test_t> pairs_lib::Transformer::transform<test_t>(const test_t& what, const geometry_msgs::msg::TransformStamped& to_frame);
template std::optional<test_t::SharedPtr> pairs_lib::Transformer::transform<test_t>(const test_t::SharedPtr& what,
                                                                                  const geometry_msgs::msg::TransformStamped& to_frame);
template std::optional<test_t::SharedPtr> pairs_lib::Transformer::transform<test_t>(const test_t::ConstSharedPtr& what,
                                                                                  const geometry_msgs::msg::TransformStamped& to_frame);
template std::optional<test_t> pairs_lib::Transformer::transformSingle<test_t>(const test_t& what, const std::string& to_frame);
template std::optional<test_t::SharedPtr> pairs_lib::Transformer::transformSingle<test_t>(const test_t::SharedPtr& what, const std::string& to_frame);
template std::optional<test_t::SharedPtr> pairs_lib::Transformer::transformSingle<test_t>(const test_t::ConstSharedPtr& what, const std::string& to_frame);
...
namespace tf2
{
  ...
  {
    const geometry_msgs::msg::Point pt = pairs_lib::geometry::fromCV(point_in);
...
namespace pairs_lib
{
  ...
  [[nodiscard]] std::optional<Eigen::Vector3d> Transformer::transformAsVector(const Eigen::Vector3d& what, const geometry_msgs::msg::TransformStamped& tf)
  {
    ...
    const geometry_msgs::msg::Vector3 vec = pairs_lib::geometry::fromEigenVec(what);
  ...
  /* specialization for pairs_msgs::msg::ReferenceStamped //{ */

  std::optional<pairs_msgs::msg::ReferenceStamped> Transformer::transformImpl(const geometry_msgs::msg::TransformStamped& tf,
                                                                            const pairs_msgs::msg::ReferenceStamped& what)
  {
    ...
    pairs_msgs::msg::ReferenceStamped ret;
  ...
  std::optional<Eigen::Vector3d> Transformer::transformImpl(const geometry_msgs::msg::TransformStamped& tf, const Eigen::Vector3d& what)
  {
    ...
    const geometry_msgs::msg::Vector3 as_vec = pairs_lib::geometry::fromEigenVec(what);
