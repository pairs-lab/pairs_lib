...
namespace pairs_lib
{
  /* LKF_PAIRS_odom constructor //{ */
  LKF_PAIRS_odom::LKF_PAIRS_odom(const std::vector<LKF_PAIRS_odom::H_t>& Hs, const double default_dt)
    : m_Hs(Hs)
  {
  ...
  /* LKF_PAIRS_odom::predict() method //{ */
  LKF_PAIRS_odom::statecov_t LKF_PAIRS_odom::predict(const statecov_t& sc, const u_t& u, const Q_t& Q, double dt) const
  {
    statecov_t ret;
  ...
  /* LKF_PAIRS_odom::correct() method //{ */
  LKF_PAIRS_odom::statecov_t LKF_PAIRS_odom::correct(const LKF_PAIRS_odom::statecov_t& sc, const LKF_PAIRS_odom::z_t& z, const LKF_PAIRS_odom::R_t& R, int param) const
  {
  ...
  /* LKF_PAIRS_odom::state_predict_optimized() method //{ */
  LKF_PAIRS_odom::x_t LKF_PAIRS_odom::state_predict_optimized(const LKF_PAIRS_odom::x_t& x_prev, const LKF_PAIRS_odom::u_t& u, double dt) const
  {
    x_t ret = x_prev;
    double& x = ret(0);
    double& dx = ret(1);
  ...
  /* LKF_PAIRS_odom::covariance_predict_optimized() method //{ */
  LKF_PAIRS_odom::P_t LKF_PAIRS_odom::covariance_predict_optimized(const LKF_PAIRS_odom::P_t& P, const LKF_PAIRS_odom::Q_t& Q, double dt) const
  {
    P_t P_ret;
