...
namespace pairs_lib
{
  ...
  void StaticEdgesVisualization::init()
  {
    ...
    publisher_ = pairs_lib::PublisherHandler<visualization_msgs::msg::MarkerArray>(node_, "~/static_markers_out");
    coordinate_publisher_ = pairs_lib::PublisherHandler<visualization_msgs::msg::MarkerArray>(node_, "~/static_markers_coordinates_out");
