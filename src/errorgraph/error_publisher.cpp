...
#if USE_ROS_TIMER == 1
using TimerType = pairs_lib::ROSTimer;
#else
using TimerType = pairs_lib::ThreadTimer;
#endif
...
namespace pairs_lib
{
  namespace errorgraph
  {
    ...
    {
      publisher_ = node_->create_publisher<pairs_msgs::msg::ErrorgraphElement>("~/errors", 10);
    ...
    void ErrorPublisher::addGeneralError(const error_id_t id, const std::string& description)
    {
      ...
      pairs_msgs::msg::ErrorgraphError msg;
    ...
    void ErrorPublisher::addWaitingForTopicError(const std::string& topic_name)
    {
      ...
      for (auto& error_wrapper : errors_)
      {
        if (error_wrapper.msg.type == pairs_msgs::msg::ErrorgraphError::TYPE_WAITING_FOR_TOPIC && error_wrapper.msg.waited_for_topic == topic_name)
        {
          error_wrapper.msg.stamp = now;
          return;
        }
      ...
      pairs_msgs::msg::ErrorgraphError msg;
      msg.type = pairs_msgs::msg::ErrorgraphError::TYPE_WAITING_FOR_TOPIC;
      msg.stamp = now;
    ...
    void ErrorPublisher::addWaitingForNodeError(const node_id_t& node_id)
    {
      ...
      for (auto& error_wrapper : errors_)
      {
        if (error_wrapper.msg.type == pairs_msgs::msg::ErrorgraphError::TYPE_WAITING_FOR_NODE && error_wrapper.msg.waited_for_node.node == node_id.node
      ...
      pairs_msgs::msg::ErrorgraphError msg;
      msg.type = pairs_msgs::msg::ErrorgraphError::TYPE_WAITING_FOR_NODE;
      msg.stamp = now;
    ...
    {
      std::scoped_lock lck(errors_mtx_);
      pairs_msgs::msg::ErrorgraphElement msg;
