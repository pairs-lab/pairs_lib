...
/**  \file
     ...
     This example may be run after building *pairs_lib* by executing `rosrun pairs_lib cyclic_example`.
...
struct degrees : public pairs_lib::geometry::cyclic<float, degrees>
{
