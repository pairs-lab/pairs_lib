...
/**  \file
     ...
     This example may be run after building *pairs_lib* by executing `rosrun pairs_lib subscribe_handler_simple_example`.
...
int main(int argc, char** argv)
{
  ...
  pairs_lib::SubscribeHandler<std_msgs::String> handler(shopts, topic_name);
