...
TEST_F(Test, test_basic)
{
  ...
  {
    std::shared_ptr<pairs_lib::ScopeTimerLogger> scope_timer_logger_ = std::make_shared<pairs_lib::ScopeTimerLogger>(node_, "", false);

    pairs_lib::ScopeTimer timer = pairs_lib::ScopeTimer(node_, "test_basic", scope_timer_logger_, true);
