...
protected:
  ...
  void initialize(const rclcpp::NodeOptions& node_options = rclcpp::NodeOptions())
  {
    ...
    tf_broadcaster_ = pairs_lib::TransformBroadcaster(node_);
  ...
  std::optional<geometry_msgs::msg::TransformStamped> wait_for_tf(const std::string& from, const std::string& to, pairs_lib::Transformer& tfr,
...
TEST_F(Test, main_test)
{
  ...
  auto tfr = pairs_lib::Transformer(node_);
...
TEST_F(Test, pairs_reference_test)
{
  ...
  if (tf_opt.has_value())
  {
    ...
    std::vector<std::pair<pairs_msgs::msg::ReferenceStamped, pairs_msgs::msg::ReferenceStamped>> test_refs;
    pairs_msgs::msg::ReferenceStamped orig, tfd;
...
template <typename T>
bool Test::trytransform_latlon(const T& tv, pairs_lib::Transformer& tfr, const char utm_zone[10], const bool ll2local, const bool expect_ok)
{
