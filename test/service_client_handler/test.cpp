...
TEST_F(Test, test_call)
{
  ...
  pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool> client1 = pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool>(node_, "service1");
...
pairs_lib::Task<std::optional<std::shared_ptr<typename std_srvs::srv::SetBool::Response>>>
call_indirect(pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool>& client, std::shared_ptr<std_srvs::srv::SetBool::Request> request, size_t depth)
{
  if (depth == 0)
  {
...
TEST_F(Test, CoroCall)
{
  ...
  const auto test_fun = [&]() -> pairs_lib::Task<> {
    tim->cancel(); // just a one-shot timer
  ...
  tim = node_->create_timer(0s, [test_fun]() -> void { pairs_lib::internal::start_task(test_fun); }, callback_group_);
  executor_->spin();
...
TEST_F(Test, test_bad_address)
{
  ...
  pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool> client1 = pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool>(node_, "random");
...
TEST_F(Test, test_get_service)
{
  ...
  pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool> client = pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool>(node_, "/my_service");
...
TEST_F(Test, test_is_service_ready)
{
  ...
  pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool> client = pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool>(node_, "/readiness_service");
...
TEST_F(Test, test_wait_for_service)
{
  ...
  pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool> client = pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool>(node_, "/wait_service");
...
TEST_F(Test, test_uninitialized_new_methods)
{
  ...
  pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool> client;
