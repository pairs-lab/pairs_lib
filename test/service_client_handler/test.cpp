...
pairs_lib::ServiceClientHandler<std_srvs::Trigger> client;
pairs_lib::ServiceClientHandler<std_srvs::Trigger> client2;
...
TEST(TESTSuite, main_test) {
  ...
  client  = pairs_lib::ServiceClientHandler<std_srvs::Trigger>(nh, "service");
  client2 = pairs_lib::ServiceClientHandler<std_srvs::Trigger>(nh, "service2");
