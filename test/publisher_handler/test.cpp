...
TEST(TESTSuite, publish_test) {
  ...
  pairs_lib::PublisherHandler<std_msgs::Int64> ph_int = pairs_lib::PublisherHandler<std_msgs::Int64>(nh, "topic1");
...
TEST(TESTSuite, throttle_test) {
  ...
  pairs_lib::PublisherHandler<std_msgs::Int64> ph_int = pairs_lib::PublisherHandler<std_msgs::Int64>(nh, "topic1", 10, false, 10.0);
