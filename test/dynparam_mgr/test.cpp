...
/* set_param_type(pairs_lib::DynparamMgr& dynparam_mgr, const std::string& param_name, const T& init_value, const std::vector<T>& test_values) //{ */

template <typename T>
void set_param_type(rclcpp::Node::SharedPtr node, pairs_lib::DynparamMgr& dynparam_mgr, T& test_var, const std::string& param_name, const T& init_value,
...
TEST_F(Test, dynparam_mgr_existing_param)
{
  ...
  auto dynparam_mgr = pairs_lib::DynparamMgr(node2, mtx);
...
template <typename T>
void dynparam_mgr_nonexisting_param(pairs_lib::DynparamMgr& dynparam_mgr, T& test_var, const std::string& param_name, const T& init_value)
{
...
TEST_F(Test, dynparam_mgr_nonexisting_param)
{
  ...
  auto dynparam_mgr = pairs_lib::DynparamMgr(node_, mtx);
...
/* default_value_test(pairs_lib::DynparamMgr& dynparam_mgr, const std::string& param_name, const T& init_value) //{ */

template <typename T>
void default_value_test(rclcpp::Node::SharedPtr node, pairs_lib::DynparamMgr& dynparam_mgr, T& test_var, const std::string& param_name, const T& init_value,
...
/* update_to_ros_test(rclcpp::Node::SharedPtr node, pairs_lib::DynparamMgr& dynparam_mgr, const std::string& param_name, const T& init_value, const
 * std::vector<T>& test_values) //{ */

template <typename T>
void update_to_ros_test(rclcpp::Node::SharedPtr node, pairs_lib::DynparamMgr& dynparam_mgr, T& test_var, const std::string& param_name, const T& var_init_value,
...
TEST_F(Test, dynparam_mgr_subnode)
{
  ...
  auto dynparam_mgr = pairs_lib::DynparamMgr(subnode, mtx);
...
template <typename T>
std::shared_ptr<CallbackTesterBase> test_callback(rclcpp::Node::SharedPtr node, pairs_lib::DynparamMgr& dynparam_mgr, const std::string& param_name,
                                                  const std::vector<T>& test_values)
{
  T test_var;
  ...
  const pairs_lib::DynparamMgr::update_cbk_t<T> cbk = std::bind(&CallbackTester<T>::callback, tester_ptr.get(), param_name, std::placeholders::_1);
...
template <typename T>
using range_t = pairs_lib::DynparamMgr::range_t<T>;

/* TEST_F(Test, dynparam_mgr_ranges) //{ */

template <typename T>
void test_ranges(rclcpp::Node::SharedPtr node, pairs_lib::DynparamMgr& dynparam_mgr, T& test_var, const T& minimum, const T& maximum,
