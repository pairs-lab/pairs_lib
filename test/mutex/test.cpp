...
TEST(TESTSuite, set_mutexed_single)
{
  ...
  pairs_lib::set_mutexed(mutex_, prev_int, new_int);
...
TEST(TESTSuite, set_mutexed_multi)
{
  ...
  pairs_lib::set_mutexed(mutex_, new_int, prev_int, new_bool, prev_bool, new_str, prev_str);
...
TEST(TESTSuite, set_mutexed_multi_tupled)
{
  ...
  pairs_lib::set_mutexed(mutex_, std::tuple(new_int, new_bool), std::forward_as_tuple(prev_int, prev_bool));
...
TEST(TESTSuite, get_mutexed)
{
  ...
  auto [cur_int, cur_bool] = pairs_lib::get_mutexed(mutex_, prev_int, prev_bool);
