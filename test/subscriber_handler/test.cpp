...
TEST_F(Test, polled)
{
  ...
  pairs_lib::PublisherHandler<std_msgs::msg::Int64> ph_int = pairs_lib::PublisherHandler<std_msgs::msg::Int64>(node_, "/topic1");

  // | ------------------- create a subscriber ------------------ |

  RCLCPP_INFO(node_->get_logger(), "creating subscriber");

  pairs_lib::SubscriberHandlerOptions sh_opts(node_);

  sh_opts.autostart = true;

  pairs_lib::SubscriberHandler<std_msgs::msg::Int64> sh_int_;

  sh_int_ = pairs_lib::SubscriberHandler<std_msgs::msg::Int64>(sh_opts, "/topic1");
...
TEST_F(Test, callback)
{
  ...
  sh_int_ = pairs_lib::SubscriberHandler<std_msgs::msg::Int64>(sh_opts, "/topic1", std::bind(&Test::callback1, this, std::placeholders::_1));
