...
gdb -ex run ./build/pairs_lib/test/param_provider/test_param_provider
# gdb -ex run ./build/pairs_lib/test/dynparam_mgr/test_dynparam_mgr
# gdb -ex run ./build/pairs_lib/test/param_loader/test_param_loader
