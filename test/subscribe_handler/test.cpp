...
TEST(TESTSuite, main_test) {
  ...
  ros::NodeHandle nh("~");
  pairs_lib::SubscribeHandler<geometry_msgs::PointStamped> sh;
  ...
  sh = pairs_lib::SubscribeHandler<geometry_msgs::PointStamped>(shopts, topic_name, timeout_callback, message_callback);
